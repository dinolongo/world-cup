...
public class GroupController {
    ...
    @GetMapping
    @Operation(summary = "Get all group standings", description = "Retrieve all World Cup group standings with caching")
    ...
    @Operation(summary = "Get group standings by group name", description = "Retrieve standings for a specific group")
